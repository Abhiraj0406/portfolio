    ...
    >
      <div className="mx-auto max-w-3xl text-center">
        <motion.h1
          ...
          className="mb-3 text-3xl font-semibold tracking-tight text-slate-100 sm:text-4xl"
        >
          Abhiraj Vishwakarma
        </motion.h1>
        <motion.p
        ...
        >
          Python Backend Developer · API Development · Data Processing · Web Scraping Automation
        </motion.p>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Backend developer with hands-on experience building REST APIs, automation workflows, and structured
          data systems using Python and FastAPI. Experienced in developing backend software for engineering
          applications and internal dashboards. Passionate about building reliable backend systems that
          extract, process, and deliver data efficiently.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          >
            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0-3-3m3 3 3-3m2 8H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414A1 1 0 0 1 19 9.414V19a2 2 0 0 1-2 2z" />
            </svg>
            Download Resume
          </a>
      ...
      >
        <a
          href="#projects"
          className="flex flex-col items-center gap-1 text-slate-500 hover:text-teal-400"
          aria-label="Scroll to projects"
        >
          <span className="text-xs">Scroll to projects</span>
          <svg className="h-5 w-5 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14 12 21 5 14m7 7V3" />
          </svg>
        </a>
      </motion.div>
    </section>
