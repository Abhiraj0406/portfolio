  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl text-center">
        ...
        >
          Python Backend Developer | API Development | Web Scraping & Automation
        </motion.p>
        <motion.h1
        ...
        <motion.p
          ...
          className="mb-4 text-lg text-slate-400 sm:text-xl leading-relaxed"
        >
          Backend developer with experience building REST APIs, automation workflows, and structured data processing systems. Skilled in Python, FastAPI, and modern backend technologies, with experience developing engineering software and scalable backend services.
        </motion.p>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-teal-500/20 px-6 py-3 text-sm font-medium text-teal-400 shadow-md transition hover:bg-teal-500/30 hover:text-teal-300 hover:shadow-teal-500/20"
      ...
      >
        <a href="#about" className="flex flex-col items-center gap-1 text-slate-500 hover:text-teal-400" aria-label="Scroll to about">
